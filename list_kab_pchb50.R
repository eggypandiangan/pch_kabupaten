...
id_grid1[id_grid1$ID_PROV_INIT=='BABEL',]
...
id_grid2 <- cbind(id_grid1,bal_gab[match(id_grid1$ID_PROV, bal_gab$ID_PROV),'BBMKG'])
colnames(id_grid2)[9] <- 'BBMKG'
id_grid2[id_grid2$ID_PROV_INIT=='BABEL',]
# id_grid2 <- merge(bal_gab, id_grid1, by = 'ID_PROV')
save(id_grid2, file = 'ID_GRID.RData')
